...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/ros_ws/install/cake_decorator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cake_decorator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cake_decorator/environment/path.sh"
